        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- Name, Email, Role_id, Phone... block --}}
                    <form action="{{ route('users.update', $user->id) }}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2.5">
                                    <select id="role_id" name="role_id" class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white/5 py-1.5 pr-8 pl-3 text-base text-white outline-1 -outline-offset-1 outline-white/10 *:bg-gray-800 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6">
